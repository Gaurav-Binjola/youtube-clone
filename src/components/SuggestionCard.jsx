  ...
  return (
    <Link to={`./video/${video?.videoId}`} >
      <div className="flex mb-3">
        ...
        <div className="flex flex-col item-center ml-3 overflow-hidden ">
            ...
            <span className='text-[12px] flex items-center lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7] '>
                ...
                {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" && (
                  <BsFillCheckCircleFill 
                    className='text-white/[0.5] text-[12px] ml-1  lg:text-[10px] xl:text-[12px]'
                  />
                ) }
              </span>
              <div className=" text-[12px] flex lg:text-[10px] xl:text-[12px] font-semibold text-white/[0.7] truncate overflow-hidden">
                    <span>
